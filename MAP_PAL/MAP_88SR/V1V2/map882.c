...
void  put_chr88_pat(unsigned char *mainram, unsigned char *vram_tmp)
{
#asm
	ld	hl, 2
	add	hl, sp
...
void  put_chr88_pat2(unsigned char *mainram, unsigned char *vram_tmp)
{
#asm
	ld	hl, 2
	add	hl, sp
...
void  put_chr_or(unsigned char *mainram, unsigned char *vram_tmp)
{
#asm
	ld	hl, 2
	add	hl, sp
...
void mask(unsigned char *mainram, unsigned char *vram_tmp)
{
#asm
	ld	hl, 2
	add	hl, sp
...
void copy(unsigned char *mainram, unsigned char *vram_tmp)
{
#asm
	ld	hl, 2
	add	hl, sp
...
void  set_chr88_pat(unsigned char *mainram, unsigned char *vram)
{
#asm
	ld	hl, 2
	add	hl, sp
