...
volatile unsigned short x = 165, y = 30;
volatile unsigned char dir = 2, dir2 = 0;
...
volatile unsigned char __far *vram_adr = MK_FP(0xa000,0);

volatile unsigned char __far *vram = MK_FP(0xa800, 0);
...
unsigned char __far st2;
unsigned char __far key_status;
